...
const AboutSection = () => {
  ...
  const shortDescription = "OLA OF LAGOS GROUP OF COMPANIES is a leading provider of car rentals,real estate property deals and premium car sales,buy,swap and sell in Lagos, Nigeria. With a commitment to excellence,customer satisfaction and nationwide delivery, we offer a wide range of vehicles and properties to suit every need.";
  const longDescription = "OLA OF LAGOS GROUP OF COMPANIES is a leading provider of car rentals,real estate property deals and premium car sales,buy,swap and sell in Lagos, Nigeria. With a commitment to excellence,customer satisfaction and nationwide delivery, we offer a wide range of vehicles and properties to suit every need. Our mission is to deliver unparalleled service and value, ensuring a seamless and trustworthy experience for all our clients. We are proud to offer nationwide delivery on all vehicle purchases, bringing your dream car right to your doorstep, no matter where you are. Our dedicated team works tirelessly to exceed expectations and build lasting relationships based on integrity and quality.";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative -mt-20">
          <div className="grid grid-cols-1 md:grid-cols-3 md:gap-8 gap-20">
            ...
            <div className="group relative bg-white p-12 shadow-lg text-center w-[350px] h-[360px] transition-all duration-300 hover:bg-black flex flex-col justify-center">
              ...
              <h3 className="text-2xl md:text-2xl text-black font-lato font-bold mb-4 transition-colors duration-300 group-hover:text-white">Quick Rentals</h3>
            ...
            <div className="group relative bg-white p-12 shadow-lg text-center w-[350px] h-[360px] transition-all duration-300 hover:bg-black flex flex-col justify-center">
              ...
              <h3 className="text-2xl md:text-2xl text-black font-lato font-bold mb-4 transition-colors duration-300 group-hover:text-white">Smart Property Deals</h3>
              <p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-300">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black text-white w-[100px] h-[100px] rounded-full flex items-center justify-center transition-all duration-300 group-hover:bg-white group-hover:text-black">
              ...
              <h3 className="text-2xl md:text-2xl text-black font-lato font-bold mb-4 transition-colors duration-300 group-hover:text-white">Premium Car Sales</h3>
              <p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-300">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            <p className="text-[#ad9271] font-semibold tracking-wider">ABOUT US</p>
            <h2 className="md:text-4xl text-3xl font-bold my-4 font-lato text-black">OOLGROUP</h2>
            <p className="text-gray-600 mb-6">
              {isExpanded ? longDescription : shortDescription}
            </p>
           
            <p className="text-black font-semibold">Waris Olayinka Akinwande, CEO</p>
            <button 
